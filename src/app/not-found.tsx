...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-bg-base flex flex-col items-center justify-center p-4 relative overflow-hidden text-center">
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 max-w-lg">
        <div className="relative">
          <h1 className="text-[150px] font-black leading-none select-none" style={{ color: 'color-mix(in srgb, var(--color-text-muted) 20%, transparent)' }}>404</h1>
        ...
        <div className="space-y-2">
          <h2 className="text-2xl sm:text-3xl font-bold theme-text-primary tracking-tight">Opa! Página não encontrada</h2>
